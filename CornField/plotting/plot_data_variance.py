...
y_margin = (max(height) - min(height)) * 0.3
ax.set_xlim(0, max(density) + x_margin)
ax.set_ylim(0, max(height) + y_margin)
...
y_margin = (max(leaf_density) - min(leaf_density)) * 0.5
...
print("✅ All three plots have been saved: scatter_density_height.png, scatter_leafarea_density.png, bar_lai.png")
